<div class="grid grid-cols-7">
    ...
    <div class="mb-10 col-start-1 col-end-8 grid grid-cols-8">
        ...
        <input type="text" id="" name="perihal"
            ...
            @elseif ($action == 'detail') class="bg-white ml-5" value="{{ $surats[0]->perihal }}" disabled
            @elseif ($action == 'edit') class="bg-gray-50 ml-5 border  col-start-2 col-end-9 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5" value="{{ $surats[0]->perihal }}" @endif
            required>
    </div>
    <div class="mb-10 col-span-3 grid grid-cols-3">
        ...
        <input type="file" id="" name="upload"
            ...
            @elseif ($action == 'detail') class="bg-white" value="{{ $surats[0]->upload }}" disabled
