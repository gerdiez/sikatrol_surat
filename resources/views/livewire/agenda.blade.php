<div class="p-5 rounded-lg bg-white">
    <div class="flex justify-between items-center">
        <a href="{{ route('agenda.show', 'export') }}"
            class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
            Download Excel</a>
