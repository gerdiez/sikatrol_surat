<div class="p-5 rounded-lg bg-white">
    <div class="flex justify-between items-center">
        <a href="{{ route('agenda.show', 'export') }}"
            class="text-white hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" style="background: linear-gradient(to right, #10B981, #059669, #047857);">
            Download Excel</a>
