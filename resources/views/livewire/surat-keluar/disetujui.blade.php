                    ...
                    @foreach ($surats as $surat)
                        ...
                        <td class="py-4">
                            <div class="tooltip static z-20 hover:relative" data-tip="Lihat">
                                ...
                                @endcan
                                @cannot('unit kerja')
                                    <a href={{ route('surat.keluar.disetujui.show', $surat->id) }}
                                        class="mr-1 text-blue-600 hover:bg-blue-300 hover:rounded-md">
                                        <i class="fa-solid fa-eye rounded-md border border-blue-400 p-1"></i>
                                    </a>
                                @endcannot
                            ...
                            @can('tata usaha')
                                <div class="tooltip static z-20 hover:relative" data-tip="Ubah">
                                    <a href={{ route('surat.keluar.disetujui.edit', $surat->id) }}
                                        ...
                                        <div class="relative w-full h-full max-w-md md:h-auto">
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-6 text-center">
                                                    <form
                                                        action="{{ route('surat.keluar.disetujui.destroy', $surat->id) }}"
                                                        method="post">
                                                        @method('delete')
                                                        @csrf
